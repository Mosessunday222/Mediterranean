...
export async function action({ request }) {
  ...
  // Clear the cart after successful order creation and we don't need to overuse it because I didn't use useSelector since this is not a component but a function
